...
class SentadillaSumo(EjercicioBase):
    ...
    def procesar_pose(self, landmarks):
        ...
        if distancia_pies < umbral_dist_pies and not self.error_flags["pies_juntos"]:
            ...
            mensajes.append("Abre mas tus pies para activar aductores")
        ...
        if angulo_espalda < 70 and not self.error_flags["espalda_inclinada"]:
            ...
            mensajes.append("Corrige la espalda, mantenla recta")

        if rodilla[0] < tobillo[0] - umbral_rodillas_abiertas and not self.error_flags["rodillas_no_abiertas"]:
            self.errores_contador["rodillas_no_abiertas"] += 1
            self.error_flags["rodillas_no_abiertas"] = True
            mensajes.append("Empuja las rodillas hacia afuera")
        ...
        if tobillo[1] > cadera[1] + 0.1 and not self.error_flags["tobillos_no_apoyados"]:
            ...
            mensajes.append("Apoya bien los talones")
